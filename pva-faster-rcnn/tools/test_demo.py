...
if __name__ == '__main__':
    ...
    caffe.set_mode_gpu()
    caffe.set_device(0)
    net = caffe.Net("output/test.prototxt", "output/m1_v2/pvanet_frcnn_384_iter_150000.caffemodel", caffe.TEST)
    net.name = os.path.splitext(os.path.basename("output/pvanet_frcnn_384_iter_130000.caffemodel"))[0]
    ...
    with open("youtube01.txt", "r") as filereader:
        ...
        for line in lines:
            ...
            line = line.replace("\n","")
            pva_detect(net, line, 0.6, vis=True, save=False, classes=CLASSES, color=COLORS)
            count = count + 1
